# Available Tasks
# Here are the tasks you can submit:
# Week 2 - Create a Dynamic Shopping Cart Program
# Task Number: 1
# Deadline: 2025-01-22 00:00:00
# Description (Part 1)
...
# 
# args = float(input('ENter discounts (if any, separated by space):'))

cart = {}

# def add_to_cart(item_name, price, *args, **kwargs):

    # i am thinking of starting the function with a while loop that runs and only breaks when the user clicks or types done
    # so in using the input, when you press ctrl + c, it breaks the input and ends the input tag
    # except KeyboardInterrupt:
    # print("\nInput cancelled!") -> This code handles that part, so this would serve as a way to break out of the while loop
    # so user inputs details and these details are stored in the parameters as arguements 

while True:
    item_name = str(input('ENter item name (or "done" to finish):'))
